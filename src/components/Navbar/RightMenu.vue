    ...
    <div class="flex items-center gap-1 sm:gap-2 justify-end px-4">
              ...
              <div class="w-96 bg-white mx-2 my-2 rounded-xl">
                <div>
                  <div class="">
                    <input
                      type="text"
                      class="rounded-2xl outline-none my-3 mx-2 bg-gray-100 border-none"
      ...
      >
        ...
        <div v-if="isShowMessager == true">
          <div
            class="bg-white w-[350px] box-border border-solid border-2 rounded-lg absolute top-full right-0"
          >
            <div class="flex justify-between">
              <h3 class="mx-3 my-1 font-semiboldbold text-2xl"><b>Đoạn chat</b></h3>
              <div class="flex">
                <div
                  class="px-2 py-1 mx-1 my-2 box-border rounded-xl hover:bg-gray-200 cursor-pointer"
                >
                  <Ellipsis />
                </div>
                <div
            ...
            <div>
              <input
                type="text"
                class="bg-gray-100 mx-4 rounded-xl"
              ...
              <div>
                <div>
                  <a href="" class="flex hover:bg-gray-100 rounded-xl m-3">
                    <img
                      class="w-14 mx-2 my-2 rounded-full"
              ...
              <div class="bg-white m-3 p-1 box-border border-solid border-2 rounded-xl shadow-sm">
                <div class="mx-1 my-1 hover:bg-gray-100 rounded-xl">
                  <a href="" class="flex">
                    <div>
                      <img
                        class="w-12 h-12 mx-1 rounded-full my-2"
                        src="https://scontent.fsgn2-9.fna.fbcdn.net/v/t39.30808-6/300362956_379273724392258_4259585475714196784_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=5f2048&_nc_ohc=ANUcRo9mmy0Q7kNvgGQJ9YF&_nc_ht=scontent.fsgn2-9.fna&oh=00_AYDDjlm8t13v5aaTOXmDv5EyYM1mQ13y21yGbPq5XJrOkA&oe=66462334"
                        alt=""
                      />
                    </div>
                    <div>
                      <p class="font-semibold my-1 mt-3 mx-2 text-xl">Thiện Ân</p>
                    </div>
                  </a>
                </div>
                ...
                <div class="mx-1 my-1 hover:bg-gray-100 rounded-xl">
                  <a href="" class="flex">
                    ...
                    <div>
                      <p class="font-semibold my-1 mt-3 mx-2 text-xl">Page chưa đặt tên</p>
                    </div>
                  </a>
                </div>
                ...
                >
                  <div class="mx-auto flex">
                    ...
                    <p class="font-semibold text-xl bg-red" target="_blank">
                ...
                <div class="mx-3 my-2">
                  <a href="" class="flex justify-between hover:bg-gray-200 py-2 px-1 rounded-xl">
                    <div class="flex">
                      ...
                      <div class="mx-2 my-1 font-semibold text-xl">Cài đặt và quyền riêng tư</div>
                    </div>
                ...
                <div class="mx-3 my-2">
                  <a href="" class="flex justify-between hover:bg-gray-200 py-1 px-1 rounded-xl">
                    <div class="flex">
                      ...
                      <div class="py-1 mx-2 font-semibold text-xl">Đăng xuất</div>
                    </div>
                  </a>
                </div>
              </div>
