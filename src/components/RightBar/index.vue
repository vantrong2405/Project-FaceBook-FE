...
<template>
  <div class="h-screen px-2 pt-10 pb-20 w-[359px] lg:block box-border overflow-auto">
    ...
    <div class="mb-3">
      <div>
        ...
        <!-- start -->
        <div
          class="flex hover:bg-gray-200 rounded-lg cursor-pointer mb-2 p-1 py-2"
          v-for="index in 10"
          :key="index"
        >
          <img
    ...
    <div id="group-conversation" class="mt-2">
      ...
      <div class="flex p-1 my-1 hover:bg-gray-200 rounded-lg cursor-pointer">
        <img
          class="w-10 h-10 mx-3 rounded-full"
          src="https://web.hn.ss.bfcplatform.vn/muadienmay/content/article2/0878913035-1620532649.jpg"
          alt=""
        />
