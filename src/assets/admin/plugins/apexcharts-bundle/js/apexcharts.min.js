            ...
            value: function (t, e) {
              ...
              return (
                  ...
                  }),
                {
                  ...
                  class: t,
                  pointStrokeOpacity:
                    n.strokeOpacity instanceof Array ? n.strokeOpacity[e] : n.strokeOpacity,
                  pointStrokeDashArray:
                    n.strokeDashArray instanceof Array ? n.strokeDashArray[e] : n.strokeDashArray,
                  pointFillOpacity:
                    n.fillOpacity instanceof Array ? n.fillOpacity[e] : n.fillOpacity,
                  seriesIndex: e
                }
              )
            }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                f &&
                  (x = this.dataLabelsCorrection(a, s, o, r, n, g, parseInt(c.style.fontSize, 10))),
                  e.globals.zoomed || ((a = x.x), (s = x.y)),
                  x.textRects &&
                    (a + x.textRects.width < -20 || a > e.globals.gridWidth + 20) &&
                    (o = '')
                ...
                if (
                  ...
                  if (
                    (y.attr({ class: 'apexcharts-datalabel', cx: a, cy: s }), c.dropShadow.enabled)
                  ) {
                    var w = c.dropShadow
            ...
            value: function (e) {
              ...
              ;(this.chartType = a.chart.type),
                'histogram' === this.chartType &&
                  ((a.chart.type = 'bar'),
                  (a = g.extend({ plotOptions: { bar: { columnWidth: '99.99%' } } }, a))),
              ...
              for (
                ...
                if (
                  ...
                  this.isFormat2DArray()
                    ...
                    ('candlestick' !== a.chart.type && 'candlestick' !== t[l].type) ||
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 *
                  (t = new p(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize))
                    .width *
                  i.length >
                  e.globals.gridWidth &&
                  0 !== e.config.xaxis.labels.rotate &&
                ...
                e.config.yaxis.map(function (r, n) {
                  ...
                  if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                    var l = e.globals.yLabelFormatters[n],
                      h =
                        String(o.niceMin).length > String(o.niceMax).length ? o.niceMin : o.niceMax,
            ...
            value: function (t) {
              ...
              if (
                ...
                o <= 3 && (o = e.globals.dataPoints),
                  ...
                  n > t / 2 && (n /= 2),
                  (a = ((n / s) * parseInt(e.config.plotOptions.bar.columnWidth, 10)) / 100) < 1 &&
                    (a = 1),
                  (a = a / (s > 1 ? 1 : 1.5) + 5),
          ...
          },
          {
            ...
            value: function () {
              ...
              ;('radar' === e.config.chart.type || this.isSparkline) &&
                ...
                this.isSparkline &&
                  ((this.lgRect = { height: 0, width: 0 }), (l = 0), (o = 0), (h = 0)),
              ...
              if (
                (e.shiftKey
                  ...
                  : this.shiftWasPressed &&
                    (s.enableZoomPanFromToolbar('zoom'), (this.shiftWasPressed = !1)),
                !(
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                if (
                  (void 0 === r &&
                    (r = e.globals.markers.size[l] + e.config.markers.hover.sizeOffset),
                  a === parseInt(o, 10))
                ) {
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              ...
              ;(t = r.getLogSeries(t)),
                ...
                this.barHelpers.initVariables(t)
              for (
                var n = a.group({ class: 'apexcharts-candlestick-series apexcharts-plot-series' }),
                  o = 0;
                o < t.length;
                o++
              ) {
    ...
    kt = (function () {
      function t(i) {
        ...
        ;(this.lineColorArr =
          ...
          (this.defaultSize =
            a.globals.svgHeight < a.globals.svgWidth ? a.globals.gridHeight : a.globals.gridWidth),
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                var x = h - o,
                  ...
                  v = s.drawPath({
                    d: m,
                    stroke:
                      this.lineColorArr instanceof Array ? this.lineColorArr[d] : this.lineColorArr,
                    strokeWidth: 0,
                    fill: b,
                ...
                if (
                  (!this.initialAnim || i.globals.resized || i.globals.dataChanged
                    ...
                    : (0 === (k = ((h - o) / this.fullAngle) * i.config.chart.animations.speed) &&
                        (k = 1),
            ...
            value: function (t) {
              var e,
                ...
                s = i.globals.dom.Paper.select(
                  '.apexcharts-'.concat(this.chartType.toLowerCase(), '-slice-').concat(t)
                ).members[0]
              if ('true' !== s.attr('data:pieClicked')) {
                ...
                ;(e = this.getPiePath({ me: this, startAngle: n, angle: o, size: a })),
                  360 !== o && s.plot(e)
              } else {
              ...
              if (
                (r
                  ...
                  : 1 === i.globals.series.length &&
                    ((f = u(i.globals.series[0], i)), (x = i.globals.seriesNames[0])),
            ...
            value: function (t) {
              ...
              for (
                ...
                e.globals.dataChanged &&
                  ((k = this.startAngle),
                  (C =
                    Math.round((this.totalAngle * g.negToZero(e.globals.previousPaths[m])) / 100) +
                    k)),
            ...
            value: function (t) {
              ...
              if (
                ...
                null === e[i][s] && ((h += x.move(r, n)), (c += x.move(r, m))),
                  ...
                  s === e[i].length - 2 &&
                    ((c = c + x.line(r, m) + x.move(r, n) + 'z'), d.push(h), g.push(c))
              }
              ...
              if (e.globals.axisCharts) {
                ...
                if (
                  ...
                  isFinite(e.globals.minX) && isFinite(e.globals.maxX) && !e.globals.isBarHorizontal
                    ...
                    : e.globals.isBarHorizontal &&
                      (a = i.calculateTimeScaleTicks(e.globals.minY, e.globals.maxY)),
        ...
        (t.prototype.selectPoints = function (t) {
          return (
            ...
            this.pointSelection.set
              ? this
              : ((this.pointSelection.set = this.parent.set()), this.drawPoints(), this)
          )
        }),
          ...
          },
          {
            ...
            value: function () {
              ...
              return new Promise(function (s, r) {
                ...
                if (
                  (null !== n &&
                    (o.xAxisLabelCorrections(n.xAxisTickWidth), l.setYAxisTextAlignments()),
                ...
                if (
                  ...
                  if (
                    ...
                    a.globals.axisCharts &&
                      (a.globals.isXNumeric || a.config.xaxis.convertedCatToNumeric))
                  )
