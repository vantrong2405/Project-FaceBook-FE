...
!(function (t, e) {
      ...
      C('inspectSource', function (t) {
        ...
        (t.exports = function (t, e, i, o) {
          ...
          'function' == typeof i &&
            ...
            t !== a
              ? (s ? !l && t[e] && (c = !0) : delete t[e], c ? (t[e] = i) : W(t, e, i))
              : c
                ? (t[e] = i)
                : z(e, i)
  ...
  var Qt =
    ...
    re =
      ...
      function (t, e) {
        ...
        return (
          null !== t
            ? ((te.prototype = T(t)), (r = new te()), (te.prototype = null), (r[Zt] = t))
            : (r = ee()),
          void 0 === e ? r : Kt(r, e)
        )
      }
    ...
    ke = function (t, e, r, n, i, o, s) {
      ...
      if (
        (y &&
          ...
          Oe !== Object.prototype &&
            a.next &&
            (de(a) !== Oe && (we ? we(a, Oe) : 'function' != typeof a[Se] && W(a, Se, Ae)),
            me(a, f, !0))),
        'values' == i &&
          v &&
          'values' !== v.name &&
  ...
  var hr = function (t, e, r, n, i) {
      ...
      return (
        (f[t] = l), At({ global: !0, forced: l != o }, f), me(l, t), i || r.setStrong(l, t, n), l
      )
    },
    dr = er.getWeakData,
    pr = K.set,
  ...
  var Gr = function (t, e, r) {
      ...
      if ('function' != typeof t) throw new TypeError(Tr)
      return (
        Xr(r) && ((n = 'leading' in r ? !!r.leading : n), (i = 'trailing' in r ? !!r.trailing : i)),
  ...
  var ci = (function () {
    ...
    ui = (function () {
      function t(t, e, r) {
        if (
          ((this.activeObservations_ = []), (this.observations_ = new qn()), 'function' != typeof t)
        )
      ...
      return (
        (t.prototype.observe = function (t) {
          ...
          if ('undefined' != typeof Element && Element instanceof Object) {
            ...
            e.has(t) ||
              (e.set(t, new ci(t)), this.controller_.addObserver(this), this.controller_.refresh())
          }
        }),
        ...
        Array.prototype.forEach.call(t.addedNodes, function (t) {
          1 === t.nodeType &&
            (t.hasAttribute('data-simplebar')
              ? !Yi.instances.has(t) && new Yi(t, qi(t.attributes))
              : Array.prototype.forEach.call(
                  t.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'),
                  function (t) {
                    !Yi.instances.has(t) && new Yi(t, qi(t.attributes))
                  }
                ))
