      ...
      ;(i = [r(2)]),
        (n = function (t) {
          ...
          function u(t, e, r, i, n, a, s, o) {
            if (
              !(W(t, r) < G(n, s) || G(t, r) > W(n, s) || W(e, i) < G(a, o) || G(e, i) > W(a, o))
            ) {
          ...
          var Ot = (e.pathBBox = function (t) {
            ...
            Gt = (e._pathToAbsolute = function (t) {
              ...
              if (
                ((e.is(t, Q) && e.is(t && t[0], Q)) || (t = e.parsePathString(t)), !t || !t.length)
              )
                return [['M', 0, 0]]
              var i = [],
                n = 0,
            ...
            te = (e._tofront = function (t, e) {
              e.top !== t &&
                (Kt(t, e), (t.next = null), (t.prev = e.top), (e.top.next = t), (e.top = t))
            }),
            ...
            var e = 'hasOwnProperty',
              ...
              C = function (t, e, r, i, n, a) {
                ...
                if (((f.visibility = 'hidden'), e && r)) {
                  if (
                    ((c.coordsize = l(x) + p + l(y)), (f.rotation = a * (e * r < 0 ? -1 : 1)), a)
                  ) {
                    var m = B(a, i, n)
                    ;(i = m.dx), (n = m.dy)
                  }
              ...
              A = function (n, l) {
                ...
                if (
                  ...
                  ((l.path && 'path' == n.type) || x) &&
                    ((c.path = k(
                      ~r(f.path).toLowerCase().indexOf('r') ? t._pathToAbsolute(f.path) : f.path
                    )),
                    (n._.dirty = 1),
                    'image' == n.type &&
                      ((n._.fillpos = [f.x, f.y]),
