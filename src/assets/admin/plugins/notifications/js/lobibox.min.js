    ...
    _init: function () {
      ...
      me._createMarkup(),
        ...
        me.$options.showClass &&
          (me.$el.removeClass(me.$options.hideClass), me.$el.addClass(me.$options.showClass)),
  ...
  ;(Lobibox.base = {}),
          ...
          ? (me.$input.addClass('invalid'),
            0 === $error.length &&
              (me.$el
                .find('.lobibox-body')
                .append(
                  '<p class="lobibox-input-error-message">' + me.$options.errorMessage + '</p>'
                ),
              me._position(),
              me.$input.focus()),
            !1)
    ...
    (LobiboxWindow.prototype = $.extend({}, LobiboxBase, {
      ...
      setContent: function (content) {
        var me = this
        return (
          (me.$options.content = content), me.$el.find('.lobibox-body').html('').append(content), me
        )
      },
      getContent: function () {
        var me = this
