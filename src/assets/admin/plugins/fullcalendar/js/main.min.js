...
var FullCalendar = (function (e) {
      ...
      (t.__k = T(t.__k, function (n) {
        if (null != n) {
          ...
          if (
            ...
            (c = n.ref) &&
              d.ref != c &&
              (y || (y = []), d.ref && y.push(d.ref, null, n), y.push(c, n.__c || h, n)),
            null != h)
          ) {
            var f
  ...
  function M(e, t, n, r, o) {
    var i, a, s, l, u
    if (
      (o ? 'className' === t && (t = 'class') : 'class' === t && (t = 'className'), 'style' === t)
    )
  ...
  function _n(e, t) {
    ...
    return (
      r(i, ((n = e), (o = t.dateEnv), r(r({}, kn(n.range, o, n.allDay)), { allDay: n.allDay }))), i
    )
  }
  function In(e, t, n) {
    var r = n.dateEnv,
  ...
  var Vn = (function () {
      ...
      return (
        ...
        (e.prototype.today = function () {
          var e = this.getCurrentData()
          this.unselect(),
            this.dispatch({ type: 'CHANGE_DATE', dateMarker: Wn(e.calendarOptions.now, e.dateEnv) })
        }),
        ...
        (e.prototype.addEvent = function (e, t) {
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: 'ADD_EVENTS', eventStore: Pt(s) }), this.triggerEventAdd(l), l
            )
          }
          return null
        }),
        ...
        (e.prototype.addEventSource = function (e) {
          ...
          var n = Un(e, t)
          return n
            ? (this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [n] }), new L(t, n))
            : null
        }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in jt)
            ...
            (t = Bt[e](t)), this.mutate({ standardProps: ((n = {}), (n[e] = t), n) })
          else if (e in Lt) {
            var o = Lt[e](t)
            'color' === e
  ...
  function $n(e) {
    for (
      var t = e.length > 0 ? e[0].code : 'en', n = Kn.concat(e), r = { en: Jn }, o = 0, i = n;
      o < i.length;
      o++
    ) {
      var a = i[o]
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            var u = l[s],
              ...
              f = u.buttonIcon
            if ('title' === c)
              (a = !1), i.push(Hr('h2', { className: 'fc-toolbar-title' }, t.title))
            else {
    ...
    Hi = (function () {
      ...
      return (
        ...
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a]
          return e
            ? this._sliceEventStore.apply(this, o([Be(e, Oi(t, Boolean(n)), r), {}, t, n], i)).bg
            : []
        }),
        ...
        (e.prototype._sliceDateSpan = function (e, t, n) {
          ...
          if (!e) return []
          for (
            var a = Mn(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s;
            l < u.length;
            l++
          ) {
            var c = u[l]
          ...
          return Hr(
            ...
            function (t, o, i, a, s) {
              return Hr(
                ...
                s.isStartResizable &&
                  Hr('div', { className: 'fc-event-resizer fc-event-resizer-start' }),
                s.isEndResizable &&
                  Hr('div', { className: 'fc-event-resizer fc-event-resizer-end' })
              )
            }
          )
        }),
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            o.isRendered &&
              ((o.isRendered = !1), Or(null, o.el), o.setClassNames([]), o.setHeight(''))
          Wr()
        }),
        (o.el = t),
      ...
      function t(t) {
        ...
        ;(n.dragSelection = null),
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (xn(n.dragSelection, e, n.component.context), (n.dragSelection = null))
          })
    ...
    return {
      ...
      segsByEachCol: u.map(function (t, n) {
        ...
        return (o = (function (e, t, n) {
          for (
            var o = t, i = ve(o, 1), a = { start: o, end: i }, s = [], l = 0, u = e;
            l < u.length;
            l++
          ) {
            var c = u[l],
