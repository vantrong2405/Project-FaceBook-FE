!(function (e, t) {
  ...
  function ue(e) {
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          t = (i = ie(e[r]).split('-')).length, n = (n = ie(e[r + 1])) ? n.split('-') : null;
          t > 0;
  ...
  ;(Dn.add = _n),
    ...
    (Dn.local = function (e) {
      return (
        this._isUTC &&
          (this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(Oe(this), 'm')),
        this
      )
    }),
  ...
  return (
    ...
    (e.relativeTimeThreshold = function (e, t) {
      return (
        void 0 !== In[e] && (void 0 === t ? In[e] : ((In[e] = t), 's' === e && (In.ss = t - 1), !0))
      )
    }),
