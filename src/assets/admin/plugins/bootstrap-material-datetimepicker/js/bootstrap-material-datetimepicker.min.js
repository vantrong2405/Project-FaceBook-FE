!(function (t, e) {
  ...
  e.locale('en'),
    ...
    (i.prototype = {
      ...
      initDates: function () {
        if (this.$element.val().length > 0)
          'undefined' != typeof this.params.format && null !== this.params.format
            ? (this.currentDate = e(this.$element.val(), this.params.format).locale(
                this.params.lang
              ))
          ...
          'string' == typeof this.$element.attr('value') &&
            ('undefined' != typeof this.params.format && null !== this.params.format
              ? (this.currentDate = e(this.$element.attr('value'), this.params.format).locale(
                  this.params.lang
                ))
          ...
          if ('string' == typeof this.params.currentDate)
            'undefined' != typeof this.params.format && null !== this.params.format
              ? (this.currentDate = e(this.params.currentDate, this.params.format).locale(
                  this.params.lang
                ))
      ...
      constructHTMLCalendar: function (t, i) {
        ...
        for (var s = 0; s < i.days.length; s++)
          s % 7 == 0 && (a += '</tr><tr>'),
            ...
            0 != i.days[s] &&
              ((a +=
                this.isBeforeMaxDate(e(i.days[s]), !1, !1) === !1 ||
                this.isAfterMinDate(e(i.days[s]), !1, !1) === !1
      ...
      setName: function () {
        for (
          var t = '', e = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', i = 0;
          5 > i;
          i++
        )
      ...
      setElementValue: function () {
        this.$element.trigger('beforeChange', this.currentDate),
          ...
          this.$element.val(
            e(this.currentDate).locale(this.params.lang).format(this.params.format)
          ),
      ...
      _onFocus: function () {
        ;(this.currentView = 0),
          ...
          this.params.date
            ...
            : this.params.time &&
              (this.$dtpElement.find('.dtp-time').removeClass('hidden'), this.initHours())
      },
      ...
      _onNowClick: function () {
        if (
          ((this.currentDate = e()),
          this.params.date === !0 &&
            (this.showDate(this.currentDate), 0 === this.currentView && this.initDate()),
          this.params.time === !0)
        ) {
      ...
      _onSelectHour: function (e) {
        if (!t(e.target).hasClass('disabled')) {
          ...
          for (var r = a.find('.dtp-select-hour-text'), n = 0; n < r.length; n++)
            t(r[n]).attr('fill', '#000')
      ...
      _onSelectMinute: function (e) {
        if (!t(e.target).hasClass('disabled')) {
          for (
            ...
            t(s[n]).attr('fill', 'transparent')
          for (var r = a.find('.dtp-select-minute-text'), n = 0; n < r.length; n++)
            t(r[n]).attr('fill', '#000')
