  ...
  e.locale("en"),
    (t.fn[a] = function (e, a) {
      return (
        this.each(function () {
          t.data(this, s)
            ? ("function" == typeof t.data(this, s)[e] && t.data(this, s)[e](a),
              "destroy" === e && delete t.data(this, s))
            : t.data(this, s, new i(this, e))
        }),
        this
      )
    }),
    (i.prototype = {
      ...
      initDates: function () {
        ...
        this.isAfterMinDate(this.currentDate) || (this.currentDate = e(this.minDate)),
          this.isBeforeMaxDate(this.currentDate) || (this.currentDate = e(this.maxDate))
      },
      initTemplate: function () {
        ;(this.template =
          ...
          '</button><button class="dtp-btn-cancel btn btn-flat">' +
          this.params.cancelText +
          '</button><button class="dtp-btn-ok btn btn-flat">' +
          this.params.okText +
      ...
      initButtons: function () {
        this._attachEvent(this.$dtpElement.find(".dtp-btn-cancel"), "click", this._onCancelClick.bind(this)),
          ...
          this.params.clearButton === !0 &&
            (this._attachEvent(this.$dtpElement.find(".dtp-btn-clear"), "click", this._onClearClick.bind(this)),
            this.$dtpElement.find(".dtp-btn-clear").removeClass("hidden")),
          this.params.nowButton === !0 &&
            (this._attachEvent(this.$dtpElement.find(".dtp-btn-now"), "click", this._onNowClick.bind(this)),
            this.$dtpElement.find(".dtp-btn-now").removeClass("hidden")),
          this.params.nowButton === !0 && this.params.clearButton === !0
      ...
      initHours: function () {
        ...
        for (var e = this.createSVGClock(!0), i = 0; 12 > i; i++) {
          ...
          ;(d.textContent = 0 === i && this.params.shortTime ? 12 : i),
            this.toggleTime(i, !0)
              ? (h.addEventListener("click", this._onSelectHour.bind(this)),
                d.addEventListener("click", this._onSelectHour.bind(this)))
              : ((h.className += " disabled"), (d.className += " disabled"), d.setAttribute("fill", "#bdbdbd")),
            e.appendChild(h),
            e.appendChild(d)
        }
          ...
          if (e % 5 === 0) {
            ...
            ;(d.textContent = e),
              this.toggleTime(e, !1)
                ...
                : ((d.className += " disabled"), d.setAttribute("fill", "#bdbdbd")),
              t.appendChild(d)
          }
        this._centerBox()
      },
        ...
        if ("undefined" != typeof this.minDate && null !== this.minDate) {
          ...
          i || a || (n.hour(0), n.minute(0), r.hour(0), r.minute(0)),
            ...
            a
              ...
              : (r.minute(0), n.minute(0), (s = parseInt(r.format("X")) >= parseInt(n.format("X"))))
        }
        return s
      },
      ...
      constructHTMLCalendar: function (t, i) {
        var a = ""
        ;(a += '<div class="dtp-picker-month">' + t.locale(this.params.lang).format("MMMM YYYY") + "</div>"),
          (a += '<table class="table dtp-picker-days"><thead>')
        for (var s = 0; s < i.week.length; s++)
          a += "<th>" + e(parseInt(i.week[s]), "d").locale(this.params.lang).format("dd").substring(0, 1) + "</th>"
        ;(a += "</thead>"), (a += "<tbody><tr>")
      ...
      setName: function () {
        for (var t = "", e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", i = 0; 5 > i; i++)
      ...
      toggleTime: function (t, i) {
        ...
        if (i) {
          ...
          s.hour(this.convertHours(t)).minute(0).second(0),
            (a = !(this.isAfterMinDate(s, !0, !1) === !1 || this.isBeforeMaxDate(s, !0, !1) === !1))
        } else {
          var s = e(this.currentDate)
          s.minute(t).second(0),
            (a = !(this.isAfterMinDate(s, !0, !0) === !1 || this.isBeforeMaxDate(s, !0, !0) === !1))
        }
        return a
      },
      ...
      _detachEvents: function () {
        for (var t = this._attachedEvents.length - 1; t >= 0; t--)
          this._attachedEvents[t][0].off(this._attachedEvents[t][1], this._attachedEvents[t][2]),
      ...
      _onFocus: function () {
        ;(this.currentView = 0),
          ...
          this.params.date
            ...
            : this.params.time && (this.$dtpElement.find(".dtp-time").removeClass("hidden"), this.initHours())
      },
      ...
      _onClearClick: function () {
        ;(this.currentDate = null),
          this.$element.trigger("beforeChange", this.currentDate),
          this.hide(),
          "undefined" != typeof t.material && this.$element.addClass("empty"),
          this.$element.val(""),
          this.$element.trigger("change", this.currentDate)
      },
      _onNowClick: function () {
        if (
          ((this.currentDate = e()),
          this.params.date === !0 && (this.showDate(this.currentDate), 0 === this.currentView && this.initDate()),
          this.params.time === !0)
        ) {
      ...
      _onSelectDate: function (e) {
        this.$dtpElement.find("a.dtp-select-day").removeClass("selected"),
          ...
          this.params.switchOnClick === !0 && this.params.time === !0 && setTimeout(this.initHours.bind(this), 200)
      },
      _onSelectHour: function (e) {
        if (!t(e.target).hasClass("disabled")) {
          for (
            var i = t(e.target).data("hour"), a = t(e.target).parent(), s = a.find(".dtp-select-hour"), n = 0;
            n < s.length;
            n++
          )
            t(s[n]).attr("fill", "transparent")
          for (var r = a.find(".dtp-select-hour-text"), n = 0; n < r.length; n++) t(r[n]).attr("fill", "#000")
          t(a.find("#h-" + i)).attr("fill", "#8BC34A"),
            t(a.find("#th-" + i)).attr("fill", "#fff"),
            this.currentDate.hour(parseInt(i)),
            this.params.shortTime === !0 && this.isPM() && this.currentDate.add(12, "hours"),
            this.showTime(this.currentDate),
            this.animateHands(),
            this.params.switchOnClick === !0 && setTimeout(this.initMinutes.bind(this), 200)
        }
      },
      _onSelectMinute: function (e) {
        if (!t(e.target).hasClass("disabled")) {
          for (
            var i = t(e.target).data("minute"), a = t(e.target).parent(), s = a.find(".dtp-select-minute"), n = 0;
            n < s.length;
            n++
          )
            t(s[n]).attr("fill", "transparent")
          for (var r = a.find(".dtp-select-minute-text"), n = 0; n < r.length; n++) t(r[n]).attr("fill", "#000")
          t(a.find("#m-" + i)).attr("fill", "#8BC34A"),
            t(a.find("#tm-" + i)).attr("fill", "#fff"),
            this.currentDate.minute(parseInt(i)),
            this.showTime(this.currentDate),
            this.animateHands(),
            this.params.switchOnClick === !0 &&
              setTimeout(
                function () {
                  this.setElementValue(), this.hide()
                }.bind(this),
