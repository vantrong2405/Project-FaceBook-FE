            ...
            value: function () {
              ...
              this.main.data('click-init', !0),
                v(this.steps).on('click', function (t) {
                  if ((t.preventDefault(), !1 === s.options.anchorSettings.anchorClickable))
                    return !0
                  ...
                  return (
                    ...
                    void (
                      (!1 === s.options.anchorSettings.enableAllAnchors && !s._isDone(e)) ||
                      s._showStep(e)
                    )
                  )
                }),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                !1 === this._triggerEvent('leaveStep', [t, this.current_index, i])
              )
                return !1
          ...
          },
          {
            ...
            value: function (t) {
              if (this.options.autoAdjustHeight) {
                ...
                this.container
                  .finish()
                  .animate({ height: e.outerHeight() }, this.options.transition.speed)
              }
            }
          },
          {
