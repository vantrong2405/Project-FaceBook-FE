  ...
  g(
    ...
    function (b, g, l, f) {
      ...
      f.getCylinderEnd = function (a, c, d) {
        var e = t(c.depth, c.width),
          b = Math.min(c.width, e) / 2,
          f = v * (a.options.chart.options3d.beta - 90 + (c.alphaCorrection || 0))
        d = c.y + (d ? c.height : 0)
        var g = 0.5519 * b,
          h = c.width / 2 + c.x,
          l = e / 2 + c.z,
        ...
        a = r(m, a, !0)
        return 2.5 > Math.abs(a[3].y - a[9].y) && 2.5 > Math.abs(a[0].y - a[6].y)
