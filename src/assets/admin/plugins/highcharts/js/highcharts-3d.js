        ...
        f.attr = function (c, e, D, E) {
          if ("object" === typeof c && b(c.faces)) {
            ...
            for (var x = 0; x < c.faces.length; x++)
              g.styledMode && delete c.faces[x].fill, f.faces[x].attr(c.faces[x], null, D, E)
            delete c.faces
          }
          return d.prototype.attr.apply(this, arguments)
        }
                ...
                : "ortho" === q
                  ? d.horiz
                    ? ((l = Math.cos(a)),
                      ...
                      (a = -Math.sin(a)),
                      (h = -l * Math.cos(h)),
                      (l = { x: g.y * h - g.z * a, y: g.z * q - g.x * h, z: g.x * a - g.y * q }),
      ...
      return (function () {
        ...
        a.wrapGetPlotLinePath = function (c) {
          ...
          "M" === k[0] &&
            ...
            this.horiz
              ? (this.isZAxis
                  ? (b.left.visible && e.push(d[0], d[2]), b.right.visible && e.push(d[1], d[3]))
                  : (b.front.visible && e.push(d[0], d[2]), b.back.visible && e.push(d[1], d[3])),
      ...
      p = (function (d) {
        ...
        a.prototype.getSeriesExtremes = function () {
          ...
          d.series.forEach(function (b) {
            ;(!b.visible && a.options.chart && a.options.chart.ignoreHiddenSeries) ||
              ((d.hasVisibleSeries = !0),
              (b = b.zData),
              b.length &&
                ((d.dataMin = Math.min(w(d.dataMin, b[0]), Math.min.apply(null, b))),
                (d.dataMax = Math.max(w(d.dataMax, b[0]), Math.max.apply(null, b)))))
          })
        }
  ...
  B(
    ...
    function (a, l, u) {
      ...
      a.Series.prototype.translate3dPoints = function () {
        ...
        a = d(l, a, !0)
        for (p = 0; p < this.data.length; p++)
          (h = this.data[p]), (k = a[p]), (h.plotX = k.x), (h.plotY = k.y), (h.plotZ = k.z)
      }
    }
  )
  B(
      ...
      d(u.prototype, "getStackBox", function (a, d, c, h, k, e, l, m) {
        ...
        if (d.is3d() && c.base) {
          ...
          g &&
            ...
            ((g = { x: n.x + (d.inverted ? l : e / 2), y: n.y, z: g.options.depth / 2 }),
            d.inverted && ((n.width = 0), 90 <= q.alpha && 270 >= q.alpha && (g.y += e)),
            (g = p([g], d, !0, !1)[0]),
            (n.x = g.x - e / 2),
            (n.y = g.y))
        }
        ...
        w &&
          ...
          d
            ? ((l.oldtranslateX = u(l.oldtranslateX, l.translateX)),
              ...
              (d = { translateX: h[0], translateY: h[1], scaleX: 0.001, scaleY: 0.001 }),
              l.attr(d),
