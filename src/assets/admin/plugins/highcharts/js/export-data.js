  ...
  g(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
    var d = a.win,
      ...
      v = (a.dataURLtoBlob = function (f) {
        if (
          (f = f.match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) &&
          3 < f.length &&
          d.atob &&
          d.ArrayBuffer &&
          d.Uint8Array &&
    ...
    function (a, d, e, c, g) {
            ...
            a.options.data.forEach(function (b, h) {
              ...
              for (q[b].xValues[C] = y.x; k < g; )
                (h = l[k]),
                  ...
                  (q[b][z + k] = w(
                    A.categoryMap[h][e],
                    A.dateTimeValueAxisMap[h] ? f.dateFormat(c.dateFormat, e) : null,
                    e
                  )),
                  k++
            })
      ...
      d.prototype.toggleDataTable = function () {
        var a,
          ...
          d =
            null === (a = null === n || void 0 === n ? void 0 : n.buttons) || void 0 === a
              ? void 0
              : a.contextButton.menuItems
        a = this.options.lang
        this.isDataTableVisible ? this.hideData() : this.viewData()
        ;(null === n || void 0 === n ? 0 : n.menuItemDefinitions) &&
          (null === a || void 0 === a ? 0 : a.viewData) &&
          a.hideData &&
          d &&
          c &&
          c.length &&
