  ...
  r(a, 'Accessibility/KeyboardNavigationHandler.js', [a['Core/Utilities.js']], function (a) {
    ...
    m.prototype = {
      run: function (a) {
        ...
        g
          ? (l = g[1].call(this, m, a))
          : 9 === m && (l = this.response[a.shiftKey ? 'prev' : 'next'])
        return l
      }
    }
    return m
      ...
      m.prototype = {
        ...
        onFocus: function (d) {
          ...
          this.isClickingChart ||
            d ||
            (null === (b = this.modules[0]) || void 0 === b ? void 0 : b.init(1))
        },
        onMouseUp: function () {
            ...
            ;(c.relatedTarget && b.container.contains(c.relatedTarget)) || f.exiting
              ...
              : (f.tabindexContainer.focus(),
                ...
                f.modules &&
                  ...
                  (c = f.modules[f.currentModuleIx]) && c.validate && !c.validate()
                    ? f.prev()
                    : c && c.init(-1)))
          })
        },
      ...
      h(a.prototype, {
        ...
        addAccessibleContextMenuAttribs: function () {
          ...
          b &&
            ...
            b.setAttribute(
              'aria-label',
              d.langFormat('accessibility.exporting.chartMenuLabel', { chart: d })
            ))
        },
        getKeyboardNavigation: function () {
          var d = this.keyCodes,
  ...
  r(
    ...
    function (a, h, q, n, p, l, g) {
      ...
      a.prototype.highlightAdjacentSeries = function (b) {
        ...
        if (!f) return !1
        if (k(c))
          return f.highlight(), (b = this.highlightAdjacentSeries(b)), b ? b : (a.highlight(), !1)
        f.highlight()
      ...
      n(f.prototype, {
        ...
        onHandlerTerminate: function () {
          ...
          null === (c = null === d || void 0 === d ? void 0 : d.onMouseOut) || void 0 === c
            ? void 0
            : c.call(d)
    ...
    function (a) {
      function m(a) {
        return (a.annotations || []).reduce(function (a, e) {
          var d
          !1 !== (null === (d = e.options) || void 0 === d ? void 0 : d.visible) &&
            (a = a.concat(e.labels))
          return a
        }, [])
      }
      function q(a) {
        var k,
          ...
          b,
          f =
            null === (e = null === (k = a.options) || void 0 === k ? void 0 : k.accessibility) ||
            void 0 === e
              ? void 0
              : e.description
        return f
          ? f
          : (null === (b = null === (d = a.graphic) || void 0 === d ? void 0 : d.text) ||
            void 0 === b
              ? void 0
              : b.textStr) || ''
      }
    ...
    function (a, h, q, n, p) {
      ...
      function z(b) {
        var a = b.series,
          ...
          e = (a = y(
            a.xAxis && a.xAxis.options.accessibility && a.xAxis.options.accessibility.enabled,
            !d.angular
          ))
            ? c(b)
            : ''
    ...
    function (a, h, q, n, p, l) {
      ...
      k(h.prototype, {
        ...
        buildAnnouncementMessage: function (c, e, k) {
          ...
          if (g.announcementFormatter && ((c = g.announcementFormatter(c, e, k)), !1 !== c))
          ...
          if (this.chart.styledMode) {
            ...
            this._hasPointMarkers &&
              ...
              this.points.forEach(function (a) {
                a.graphic &&
                  (a.graphic[a.hasForcedA11yMarker ? 'addClass' : 'removeClass'](
      ...
      h(a.prototype, {
        ...
        onChartRender: function () {
          this.chart.series.forEach(function (b) {
            !1 !== (b.options.accessibility && b.options.accessibility.enabled) && b.visible
              ? d(b)
              : e(b)
          })
        },
    ...
    function (a, h, q, n, p, l) {
      ...
      g(a.prototype, {
        ...
        onMapKbdTab: function (b, a) {
          ...
          b = b.response
          var d =
            ((a = a.shiftKey) && !this.focusedMapNavButtonIx) || (!a && this.focusedMapNavButtonIx)
              ...
              [
                ...
                function (b, a) {
                  return this.response[
                    (b === d.tab && a.shiftKey) || b === d.left || b === d.up ? 'prev' : 'next'
                  ]
                }
              ],
              [
      ...
      e(h.prototype, {
        ...
        defaultBeforeChartFormatter: function () {
          var b,
            ...
            l =
              c.sonify &&
              (null === (b = c.options.sonification) || void 0 === b ? void 0 : b.enabled)
        ...
        getTypeDescriptionText: function () {
          var b = this.chart
          return b.types
            ? b.options.accessibility.typeDescription || b.getTypeDescription(b.types)
            : ''
        },
        ...
        getSonifyButtonText: function (b) {
          var a,
            c = this.chart
          if (!1 === (null === (a = c.options.sonification) || void 0 === a ? void 0 : a.enabled))
            return ''
        ...
        getAxesDescription: function () {
          var a = this.chart,
            c = function (c, d) {
              ...
              return (
                1 < c.length ||
                (c[0] && b(c[0].options.accessibility && c[0].options.accessibility.enabled, d))
              )
            },
        ...
        getAxisDescriptionText: function (b) {
          var a = this,
            ...
            d = c[b]
          return c.langFormat(
            'accessibility.axis.' + b + 'Description' + (1 < d.length ? 'Plural' : 'Singular'),
            {
              chart: c,
          ...
          d &&
            (d.textStr &&
              d.element.setAttribute(
                'aria-label',
                g(a.langFormat('accessibility.credits', { creditsStr: d.textStr }))
              ),
            m(a, d.element))
        },
        destroy: function () {
        ...
        a.series.forEach(function (a) {
          ...
          a.points.forEach(function (a) {
            a.options &&
              a.options.color &&
              a.update(
                { color: g.color || 'windowText', borderColor: g.borderColor || 'window' },
                !1
              )
          })
        })
      ...
      Object.keys(b).forEach(function (f) {
        ...
        'undefined' !== typeof m &&
          ...
          g(
            ...
            !1,
            a,
            ((k = {}), (k[e.join('.') + '.' + f] = d.join('.') + '.' + b[f].join('.')), k)
          ))
      })
    }
    function n(a) {
      ...
      ;['description', 'typeDescription'].forEach(function (b) {
        var f
        e[b] &&
          ((d[b] = e[b]), g(32, !1, a, ((f = {}), (f['chart.' + b] = 'use accessibility.' + b), f)))
      })
    }
    function p(a) {
    ...
    function (a, h) {
      function m(a, g) {
        ...
        if (-1 < h) {
          ...
          if ((g = g[e[0]]))
            for (
              h = isNaN(h) ? g.length : h, h = 0 > h ? g.length + h : Math.min(h, g.length), e = 0;
              e < h;
              ++e
            )
              a += b + g[e] + k
    ...
    function (a, h, q, n) {
      function m(a) {
        if (!a.focusBorderDestroyHook) {
          ...
          a.destroy = function () {
            var c, d
            null === (d = null === (c = a.focusBorder) || void 0 === c ? void 0 : c.destroy) ||
            void 0 === d
              ? void 0
              : d.call(c)
