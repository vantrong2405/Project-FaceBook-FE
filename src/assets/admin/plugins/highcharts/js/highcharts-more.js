    ...
    function (d, a, g, h, b) {
      ...
      h = (function () {
        ...
        m.prototype.setOptions = function (m) {
          this.options = B(this.defaultOptions, this.chart.angular ? { background: {} } : void 0, m)
        }
        m.prototype.render = function () {
          ...
          this.updateCenter()
          if (e)
            for (e = l(e), m = Math.max(e.length, this.background.length || 0), a = 0; a < m; a++)
              e[a] && this.axis
      ...
      t(g, 'beforeGetHoverData', function (m) {
        ...
        l.polar &&
          ...
          (m.filter = function (a) {
            return (
              a.visible &&
              !(!m.shared && a.directTouch) &&
              z(a.options.enableMouseTracking, !0) &&
              (!l.hoverPane || a.xAxis.pane === l.hoverPane)
            )
          }))
      })
      t(g, 'afterGetHoverData', function (m) {
        ...
        m.hoverPoint &&
          ...
          m.hoverPoint.plotY &&
          l.hoverPane &&
          !r(m.hoverPoint.plotX, m.hoverPoint.plotY, l.hoverPane.center) &&
          (m.hoverPoint = void 0)
      })
      a.Pane = h
      return a.Pane
        ...
        a.init = function (a) {
          ...
          a.getPosition = function (k, p) {
            ...
            return this.postTranslate(
              this.isCircular ? k : this.angleRad,
              l(this.isCircular ? p : 0 > k ? 0 : k, this.center[2] / 2) - this.offset
            )
          }
          a.postTranslate = function (k, p) {
            ...
            return { x: c.plotLeft + f[0] + Math.cos(k) * p, y: c.plotTop + f[1] + Math.sin(k) * p }
          }
          ...
          a.getTitlePosition = function () {
            ...
            return {
              ...
              y: p.plotTop + k[1] - { high: 0.5, middle: 0.25, low: 0 }[c.align] * k[2] + (c.y || 0)
            }
          }
          a.createLabelCollector = function () {
            var k = this
            return function () {
              if (k.isRadial && k.tickPositions && !0 !== k.options.labels.allowOverlap)
                return k.tickPositions
                  .map(function (p) {
        ...
        a.compose = function (e, h) {
            ...
            if ('colorAxis' === A) this.isRadial = !1
              ...
              f || n
                ? ((this.isRadial = !0),
                  ...
                  this.labelCollector && p.labelCollectors.push(this.labelCollector))
                : (this.isRadial = !1)
              k && m && (k.axis = this)
              this.isCircular = m
            }
          ...
          b(e, 'afterInit', function () {
            var k = this.chart,
              ...
              c = this.pane,
              f = c && c.options
            ;(k.angular && this.isXAxis) ||
              !c ||
              (!k.angular && !k.polar) ||
              ((this.angleRad = ((p.angle || 0) * Math.PI) / 180),
        ...
        },
        {
          ...
          translate: function () {
            ...
            m.points.forEach(function (e) {
              ...
              e.isNull
                ? (e.plotY = null)
                : ((e.plotLow = k),
                  (e.plotHigh = a.translate(l ? m.modifyValue(b, e) : b, 0, 1, 0, 1)),
                  l && (e.yBottom = e.plotHigh))
            })
            this.chart.polar &&
          ...
          getGraphPath: function (a) {
            ...
            for (b = a.length; b--; ) {
              var u = a[b]
              var A = p
                ? { plotX: u.rectPlotX, plotY: u.yBottom, doCurve: !1 }
                : { plotX: u.plotX, plotY: u.plotY, doCurve: !1 }
          ...
          drawDataLabels: function () {
            ...
            if (c.enabled)
              for (e = l; e--; )
                if ((k = a[e]))
                  k.dataLabels = [k.dataLabelUpper, k.dataLabel].filter(function (c) {
                    return !!c
                  })
    ...
    a(
      ...
      },
      {
        ...
        drawPoints: function () {
          ...
          h
            ? h.animate({ translateX: m[0], translateY: m[1] })
            : ((a.pivot = d
        ...
        animate: function (a) {
          var l = this
          a ||
            l.points.forEach(function (a) {
              var b = a.graphic
              b &&
                (b.attr({ rotation: (180 * l.yAxis.startAngleRad) / Math.PI }),
                b.animate({ rotation: a.shapeArgs.rotation }, l.options.animation))
            })
        },
        render: function () {
        ...
        drawPoints: function () {
          ...
          a.points.forEach(function (q) {
            ...
            'undefined' !== typeof q.plotY &&
              ...
              (c = p + k),
              (f = Math.round(k / 2)),
              (z = Math.floor(n ? q.q1Plot : q.lowPlot)),
              (l = Math.floor(n ? q.q3Plot : q.lowPlot)),
  ...
  C(
    ...
    function (d, a, g, h, b, r) {
      ...
      ;(function (a) {
        ...
        function f() {
          for (var c = this.axes, f = this.series, n = f.length; n--; )
            f[n].options.stacking &&
      ...
      r(
        ...
        },
        {
            ...
            for (a = m.length; h < a; h++) {
              ...
              if (A) {
                ...
                (w = Math.max(l, l + t) + r[0]),
                  ...
                  e.isSum
                    ? ((d.y = b.translate(r[1], 0, 1, 0, 1)),
                      (d.height = Math.min(b.translate(r[0], 0, 1, 0, 1), b.len) - d.y))
                    : e.isIntermediateSum
                      ? (0 <= t ? ((g = r[1] + c), (t = c)) : ((g = c), (t = r[1] + c)),
                        b.reversed && ((g ^= t), (t ^= g), (g ^= t)),
                        (d.y = b.translate(g, 0, 1, 0, 1)),
                        (d.height = Math.abs(d.y - Math.min(b.translate(t, 0, 1, 0, 1), b.len))),
                        (c += r[1]))
                      : ((d.height =
                          0 < g
                            ? b.translate(l, 0, 1, 0, 1) - d.y
                            : b.translate(l, 0, 1, 0, 1) - b.translate(l - g, 0, 1, 0, 1)),
                        (l += g),
                        (e.below = l < v(u, 0))),
          ...
          getCrispPath: function () {
            ...
            for (e = 1; e < c; e++) {
              ...
              !q &&
                ...
                d &&
                ((0 > g.y && !l) || (0 < g.y && l)) &&
                ((m[m.length - 2][2] += d.height), (m[m.length - 1][2] += d.height))
            }
            return m
          },
          drawGraph: function () {
          ...
          setStackedPoints: function () {
            function a(c, f, n, a) {
              if (B) for (n; n < B; n++) v.stackState[n] += a
            ...
            if (this.visible || !this.chart.options.chart.ignoreHiddenSeries) {
              ...
              for (var t = 0; t < m; t++) {
                ...
                z && z.isIntermediateSum
                  ? (a(g, h, 0, g), (g = h), (h = f), (n ^= u), (u ^= n), (n ^= u))
                  : z && z.isSum
                    ? (a(f, d, B), (n = f))
                    : (a(n, y, 0, d), z && ((d += y), (h += y)))
                v.stateIndex++
          ...
          getExtremes: function () {
            ...
            if (a) {
              ...
              return { dataMin: B(c), dataMax: x(f) }
            }
    ...
    function (d, a, g, h, b) {
      ...
      v = (function () {
        ...
        a.prototype.setOptions = function () {
          ...
          c.forEach(function (n, u) {
            ...
            g || z(!0, c[u], { bubbleStyle: z(!1, l), connectorStyle: z(!1, q), labelStyle: e })
          }, this)
        }
        ...
        a.prototype.correctSizes = function () {
          ...
          1 < Math.abs(Math.ceil(a.maxPxSize) - this.options.maxSize) &&
            (this.updateRanges(this.options.minSize, a.maxPxSize), c.render())
        }
        return a
      })()
      a(h, 'afterGetAllItems', function (a) {
        ...
        c &&
          c.ranges &&
          c.ranges.length &&
          (n.ranges.length && (n.autoRanges = !!n.ranges[0].autoRanges), this.destroyItem(c))
        0 <= b &&
          f.enabled &&
          n.enabled &&
          ((n.seriesIndex = b),
          (this.bubbleLegend = new g.BubbleLegend(n, this)),
      ...
      h.prototype.retranslateItems = function (a) {
        ...
        this.allItems.forEach(function (q, u) {
          ...
          if ((n = q.movementX) || (b && q.ranges))
            (n = b ? c - q.options.maxSize / 2 : c + n), q.legendGroup.attr({ translateX: n })
          u > a[l].step && l++
          q.legendGroup.attr({ translateY: Math.round(f + a[l].height / 2) })
    ...
    function (d, a, g, h) {
        ...
        },
        {
          ...
          animate: function (a) {
            !a &&
              ...
              this.points.forEach(function (a) {
                ...
                b &&
                  b.width &&
                  (this.hasRendered || b.attr({ x: a.plotX, y: a.plotY, width: 1, height: 1 }),
          ...
          translate: function () {
            ...
            for (a = b.length; a--; ) {
              var c = b[a]
              var f = l ? l[a] : 0
              z(f) && f >= this.minPxSize / 2
                ? ((c.marker = B(c.marker, { radius: f, width: 2 * f, height: 2 * f })),
                  (c.dlBox = { x: c.plotX - f, y: c.plotY - f, width: 2 * f, height: 2 * f }))
      ...
      h.prototype.beforePadding = function () {
        ...
        this.series.forEach(function (c) {
          var f = c.options
          !c.bubblePadding ||
            (!c.visible && e.options.chart.ignoreHiddenSeries) ||
    ...
    function (d, a, g) {
      ...
      a.dragNodesMixin = {
        onMouseDown: function (a, h) {
          ...
          a.fixedPosition = { chartX: h.chartX, chartY: h.chartY, plotX: a.plotX, plotY: a.plotY }
          a.inDragMode = !0
        },
        onMouseMove: function (a, h) {
          if (a.fixedPosition && a.inDragMode) {
            ...
            if (5 < Math.abs(g) || 5 < Math.abs(d))
              (g = a.fixedPosition.plotX - g),
                (d = a.fixedPosition.plotY - d),
                b.isInsidePlot(g, d) &&
                  ((a.plotX = g),
                  (a.plotY = d),
                  (a.hasDragged = !0),
    ...
    d.networkgraphIntegrations = {
      verlet: {
        ...
        integrate: function (a, g) {
          ...
          g.plotX += d
          g.plotY += h
          g.temperature = a.vectorLength({ x: d, y: h })
        },
        getK: function (a) {
      ...
      euler: {
        ...
        integrate: function (a, d) {
          ...
          var h = (d.temperature = a.vectorLength({ x: d.dispX, y: d.dispY }))
          0 !== h &&
            ((d.plotX += (d.dispX / h) * Math.min(Math.abs(d.dispX), a.temperature)),
            (d.plotY += (d.dispY / h) * Math.min(Math.abs(d.dispY), a.temperature)))
        },
        getK: function (a) {
    ...
    function (d, a, g) {
      ...
      t(a.layouts['reingold-fruchterman'].prototype, {
        ...
        step: function () {
          ...
          b.enableSimulation &&
            ...
            b.maxIterations-- && isFinite(b.temperature) && !b.isStable()
              ? (b.simulation && a.win.cancelAnimationFrame(b.simulation),
        ...
        setArea: function (a, b, d, e) {
          this.box = { left: a, top: b, width: d, height: e }
        },
        setK: function () {
      ...
      h(d, 'render', function () {
        function a(a) {
          a.maxIterations-- &&
            ...
            !a.isStable() &&
            !a.enableSimulation &&
            (a.beforeStep && a.beforeStep(), a.step(), (d = !1), (b = !0))
        }
        var b = !1
      ...
      g.networkgraphIntegrations.packedbubble = {
        ...
        barycenter: function () {
          ...
          d.forEach(function (c) {
            a.options.splitSeries && !c.isParentNode
              ? ((e = c.series.parentNode.plotX), (q = c.series.parentNode.plotY))
              : ((e = b.width / 2), (q = b.height / 2))
            c.fixedPosition ||
              ((c.plotX -= ((c.plotX - e) * f) / (c.mass * Math.sqrt(d.length))),
              (c.plotY -= ((c.plotY - q) * f) / (c.mass * Math.sqrt(d.length))))
          })
        },
      ...
      g.layouts.packedbubble = a(k, {
        ...
        repulsiveForces: function () {
          ...
          a.nodes.forEach(function (c) {
            ...
            a.nodes.forEach(function (n) {
              ...
              c === n ||
                c.fixedPosition ||
                (!a.options.seriesInteraction && c.series !== n.series) ||
                ((d = a.getDistXY(c, n)),
        ...
        applyLimitBox: function (a) {
          if (this.options.splitSeries && !a.isParentNode && this.options.parentNodeLimit) {
            ...
            0 > b && b > -2 * a.marker.radius && ((a.plotX -= 0.01 * c.x), (a.plotY -= 0.01 * c.y))
          }
        ...
        },
        {
          ...
          render: function () {
            ...
            this.options.dataLabels.allowOverlap ||
              (this.data.forEach(function (c) {
                m(c.dataLabels) &&
                  c.dataLabels.forEach(function (c) {
                    a.push(c)
                  })
              }),
          ...
          createParentNodes: function () {
            ...
            e ||
              ...
              (a.parentNode = g),
              d.addElementsToCollection([a], d.series),
          ...
          addLayout: function () {
            ...
            h ||
              ...
              (b[a.type] = h = new g.layouts[a.type]()),
              h.init(a),
            ...
            if (a.fixedPosition && !a.removed) {
              ...
              g &&
                ...
                g.nodes.forEach(function (f) {
                  a &&
                    a.marker &&
                    f !== a.series.parentNode &&
                    ((b = d.getDistXY(a, f)),
                    (c = d.vectorLength(b) - f.marker.radius - a.marker.radius),
                    0 > c &&
                      (f.series.addPoint(e(a.options, { plotX: a.plotX, plotY: a.plotY }), !1),
                      d.removeElementFromCollection(a, d.nodes),
                      a.remove()))
                })
          ...
          select: function (a, b) {
            ...
            this.isParentNode
              ? ((c.getSelectedPoints = c.getSelectedParentNodes),
                ...
                (c.getSelectedPoints = g.Chart.prototype.getSelectedPoints))
              : h.prototype.select.apply(this, arguments)
          }
        }
      )
  ...
  C(
    ...
    function (d, a, g, h, b, r) {
      ...
      p.getConnectors = function (a, b, c, d) {
        ...
        f = { rightContX: h, rightContY: k, leftContX: n, leftContY: g, plotX: f, plotY: e }
              ...
              (this.hasClipCircleSetter = !!this.eventsToUnbind.push(
                t(this, 'afterRender', function () {
                  if (b.polar) {
                    ...
                    this.clipCircle
                      ? this.clipCircle.animate({ x: c[0], y: c[1], r: c[2] / 2, innerR: c[3] / 2 })
      ...
      var c = function (b, c) {
        ...
        if (f.polar)
          if (d.isRadialBar)
            c ||
              ((d.startAngleRad = m(d.translatedThreshold, d.xAxis.startAngleRad)),
              ...
              if (((e = x(e)), d.is('column'))) {
                ...
                c
                  ? ((b = {
                    ...
                    g.attr(b),
                    h && h.attr(b))
                  : ((b = { translateX: l, translateY: k, scaleX: 1, scaleY: 1 }),
                    g.animate(b, e),
                    h && h.animate(b, e))
          }
        else b.call(this, c)
            ...
            for (; f--; ) {
              ...
              d.inverted
                ? ((w = e.postTranslate(b.rectPlotY, w + b.pointWidth / 2)),
                  (b.tooltipPos = [w.x - d.plotLeft, w.y - d.plotTop]))
        ...
        y(k, 'alignDataLabel', function (a, b, c, d, e, g) {
          ...
          f.polar
            ? ((a = (b.rectPlotX / Math.PI) * 180),
              f.inverted
                ? ((this.forceDL = f.isInsidePlot(b.plotX, Math.round(b.plotY), !1)),
                  h && b.shapeArgs
                    ? ((e = b.shapeArgs),
                      (e = this.yAxis.postTranslate(
                        (e.start + e.end) / 2 - this.xAxis.startAngleRad,
