...
;(function (b) {
  "object" === typeof module && module.exports
    ...
    : "function" === typeof define && define.amd
      ? define("highcharts/modules/variable-pie", ["highcharts"], function (g) {
          b(g)
          b.Highcharts = g
          return b
        })
    ...
    d(
      ...
      },
      {
        ...
        calculateExtremes: function () {
          ...
          c.length &&
            ((a = p(b.zMin, n(c.filter(this.zValEval)))),
            (c = p(b.zMax, g(c.filter(this.zValEval)))),
            this.getRadii(a, c, this.minPxSize, this.maxPxSize))
        },
        getRadii: function (a, b, c, d) {
          ...
          for (l; l < q; l++) {
            ...
            h <= a
              ...
              : h >= b
                ? (h = d / 2)
                : ((h = 0 < u ? (h - a) / u : 0.5), p && (h = Math.sqrt(h)), (h = Math.ceil(c + h * (d - c)) / 2))
            k.push(h)
          }
          this.radii = k
        },
        translate: function (a) {
          ...
          for (k = 0; k < h; k++) {
            ...
            r = Math.cos(e) * m
            m *= Math.sin(e)
            f.tooltipPos = [a[0] + 0.7 * v, a[1] + 0.7 * w]
            ...
            f.labelPosition = {
              ...
              connectorPosition: {
                breakAt: { x: a[0] + r + Math.cos(e) * v, y: a[1] + m + Math.sin(e) * v },
