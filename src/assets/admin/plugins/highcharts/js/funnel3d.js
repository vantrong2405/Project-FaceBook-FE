    ...
    function (d, m, k, h) {
      ...
      k(
        ...
        },
        {
          ...
          translate: function () {
            ...
            e = this.data
            var z, l, x, A, G, D, r
            this.getWidthAt = v = function (b) {
              var a = t - n / 2
              return b > k || n === h ? m : m + (p - m) * (1 - (b - a) / (n - h))
            }
            this.center = [w, t, n]
            this.centerX = w
            ...
            e.forEach(function (e) {
              ...
              x >= k
                ...
                : A > k &&
                  ...
                  (A = k),
                  (r.bottom.width = q),
                  (r.middle = { fraction: D ? (k - x) / D : 0, width: q }))
              g &&
                ((r.y = x = t + n / 2 - (f + z) * n),
                r.middle && (r.middle.fraction = 1 - (D ? r.middle.fraction : 0)),
                (q = r.width),
                (r.width = r.bottom.width),
                (r.bottom.width = q))
              e.shapeArgs = E(e.shapeArgs, r)
              e.percentage = 100 * z
              e.plotX = w
        ...
        fillSetter: function (a) {
          ...
          c.linearGradient ||
            ...
            (c = {
              ...
              stops: [
                [0, l(a).brighten(-0.2).get()],
                [0.5, a],
                [1, l(a).brighten(-0.2).get()]
              ]
            })
          c.linearGradient
            ? b.sideGroups.forEach(function (a) {
                var e = b[a].gradientBox,
                  f = c.linearGradient,
                  g = p(c, {
                    linearGradient: {
                      x1: e.x + f.x1 * e.width,
      ...
      m.funnel3dPath = function (a) {
        ...
        k &&
          ...
          (v = this.getCylinderEnd(b, q, !1)),
          (n = this.getCylinderEnd(b, q, !1)))
        d = {
          top: f,
          bottom: t,
          frontUpper: this.getCylinderFront(f, v),
          zIndexes: {
        ...
        k &&
          ((f = 1 !== Math.min(l, h) / Math.max(l, h)),
          p(!0, d, {
            frontLower: this.getCylinderFront(n, t),
            backLower: this.getCylinderBack(n, t),
            rightLower: this.getCylinderFront(
              this.getCylinderEnd(b, p(w, { alphaCorrection: f ? -c : 0 }), !0),
              this.getCylinderEnd(b, p(q, { alphaCorrection: f ? -c : 0 }), !1)
            ),
