          ...
          if (!b) {
            ...
            d.isSVG &&
              ...
              c &&
                ...
                (b.height = Math.abs(d * Math.cos(g)) + Math.abs(e * Math.sin(g)))))
            if (B && 0 < b.height) {
      ...
      a.prototype.addLabel = function () {
        ...
        if ((B = M && M.list))
          a.shortenLabel = function () {
            for (N = 0; N < B.length; N++)
              if (
                (A.attr({
                  text: t.labelFormatter.call(C(a.formatCtx, { dateTimeLabelFormat: B[N] }))
                }),
        ...
        D(A) || a.movedLabel
          ? A &&
            A.textStr !== f &&
            !m &&
            (!A.textWidth || (g.style && g.style.width) || A.styles.width || A.css({ width: null }),
            A.attr({ text: f }),
        ...
        f && f.textStr === a
          ...
          : L(h.ticks, function (g) {
              m ||
                ...
                !g.label ||
                g.label.textStr !== a ||
                ((p.movedLabel = g.label), (m = !0), (g.labelPos = p.movedLabel.xy), delete g.label)
            })
        if (!m && (p.labelPos || f)) {
    ...
    function (f, a, n, y, D) {
      ...
      y = (function () {
        ...
        e.prototype.setTickInterval = function (c) {
          ...
          g &&
            (b.positiveValuesOnly && !c && 0 >= Math.min(b.min, r(b.dataMin, b.min)) && E(10, 1, e),
          ...
          Q &&
            ...
            !q(M) && b.min < A && b.dataMin >= A
              ? (b.min = b.options.minRange ? Math.min(A, b.max - b.minRange) : A)
              : !q(F) &&
                b.max > A &&
                b.dataMax <= A &&
          ...
          b.dateTime ||
            ...
            (b.tickInterval = d(
              ...
              void 0,
              u(b.tickInterval),
              r(k.allowDecimals, 0.5 > b.tickInterval || void 0 !== this.tickAmount),
              !!this.tickAmount
            ))
        ...
        e.prototype.setTickPositions = function () {
          ...
          !e &&
            ...
            !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
              ? (e = this.dateTime
                  ? this.getTimeTicks(
                      this.dateTime.normalizeTimeTickInterval(this.tickInterval, c.units),
                      this.min,
                      this.max,
                      c.startOfWeek,
                      this.ordinal && this.ordinal.positions,
        ...
        this.followPointer && a
          ...
          : h[0].tooltipPos
            ...
            : (h.forEach(function (g) {
              ...
              (h = [
                d ? k.plotWidth - t : m,
                this.shared && !d && 1 < h.length && a ? a.chartY - l : d ? k.plotHeight - m : t
              ]))
          ...
          this.outside &&
            ...
            (this.renderer = g =
              new f.Renderer(
                ...
                0,
                0,
                null === (a = this.chart.options.chart) || void 0 === a ? void 0 : a.style,
                void 0,
                void 0,
                g.styledMode
              )))
          ...
          b = function (b) {
            ...
            return [b, h ? B : M, h ? a : l].concat(
              p
                ? [
                    h ? e(a) : c(l),
                    h ? t.left - d + e(k.plotX + g.plotLeft) : t.top - d + c(k.plotY + g.plotTop),
                    0,
                    h ? B : M
                  ]
                : [
      ...
      m.prototype.renderSplit = function (a, l) {
        function k(b, c, e, d, g) {
          ...
          e
            ...
            : ((c -= K), (b = g ? b - d - z : b + z), (b = y(b, g ? b : n.left, n.right)))
          return { x: b, y: c }
        }
        var g = this,
          d = g.chart,
        ...
        l.prototype.drag = function (a) {
          ...
          if (!e || !e.touch)
            if (
              (k < m ? (k = m) : k > m + u && (k = m + u),
              h < p ? (h = p) : h > p + F && (h = p + F),
              (this.hasDragged = Math.sqrt(Math.pow(c - k, 2) + Math.pow(b - h, 2))),
              10 < this.hasDragged)
            ) {
        ...
        l.prototype.pinch = function (a) {
          ...
          'touchstart' === a.type
            ...
            : g.followTouchMove && 1 === l
              ...
              : h.length &&
                (t || (g.selectionMarker = t = q({ destroy: C, touch: !0 }, d.plotBox)),
              ...
              m.shared && f
                ? f.forEach(function (d) {
                    ...
                    d.series.isCartesian &&
                      (d.series.xAxis.crosshair && d.series.xAxis.drawCrosshair(null, d),
                      d.series.yAxis.crosshair && d.series.yAxis.drawCrosshair(null, d))
                  })
                : l &&
        ...
        l.prototype.scaleGroups = function (a, g) {
          ...
          d.series.forEach(function (k) {
            ...
            k.xAxis &&
              ...
              k.group &&
              (k.group.attr(h),
              k.markerGroup && (k.markerGroup.attr(h), k.markerGroup.clip(g ? d.clipRect : null)),
      ...
      l = (function () {
        ...
        a.prototype.layoutItem = function (a) {
          ...
          h &&
            this.itemX - g + d > p &&
            ((this.itemX = g),
            this.lastLineHeight && (this.itemY += l + this.lastLineHeight + f),
        ...
        Y = (function () {
          ...
          D.prototype.getChartSize = function () {
            ...
            this.chartHeight = Math.max(
              0,
              P(b, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 400)
            )
          }
            ...
            if (b)
              for (; c && c.style; )
                c.hcOrigStyle && (m(c, c.hcOrigStyle), delete c.hcOrigStyle),
                  c.hcOrigDetached && (v.body.removeChild(c), (c.hcOrigDetached = !1)),
                  (c = c.parentNode)
            else
              for (; c && c.style; ) {
                v.body.contains(c) ||
          ...
          ? ((this.fixedDiv = D(
            ...
            (this.fixedRenderer = f =
              new a.Renderer(
                ...
                this.chartWidth,
                this.chartHeight,
                null === (n = this.options.chart) || void 0 === n ? void 0 : n.style
              )),
            ...
            if (d.length && (l || m) && r && 'undefined' !== typeof r.min) {
              ...
              d.forEach(function (e, d) {
                ...
                t &&
                  b.isVML &&
                  (k = r.isXAxis
                    ? { x: 0, y: v ? n : x, height: k.width, width: c.chartWidth }
                    : {
      ...
      n.cleanRecursively = function (a, d) {
        ...
        g(a, function (g, e) {
          if (h(a[e], !0) && !a.nodeType && d[e])
            (g = n.cleanRecursively(a[e], d[e])), Object.keys(g).length && (f[e] = g)
          ...
          if (l && this.points) {
            ...
            this.points.forEach(function (b) {
              b &&
                ...
                !1 === A.showInLegend && b.legendItem && f.legend.destroyItem(b))
            }, this)
          }
          h.initialType = c
          f.linkSeries()
        ...
        },
        {
          ...
          animate: function (a) {
            ...
            a ||
              l.forEach(function (a) {
                ...
                d &&
                  g &&
                  (d.attr({ r: K(a.startR, f.center && f.center[3] / 2), start: k, end: k }),
          ...
          getX: function (a, f, l) {
            ...
            return (
              ...
              (0 < l.labelDistance ? (f ? -1 : 1) * this.options.dataLabels.padding : 0)
            )
          },
        ...
        },
        {
          ...
          haloPath: function (a) {
            ...
            return this.sliced || !this.visible
              ? []
              : this.series.chart.renderer.symbols.arc(f.x, f.y, f.r + a, f.r + a, {
                  innerR: f.r - 1,
                  start: f.start,
                  end: f.end
                })
        ...
        pan: function (d, f) {
          ...
          K(this, 'pan', { originalEvent: d }, function () {
            ...
            f.forEach(function (e) {
              ...
              p = Math.min(
                a.pick(null === x || void 0 === x ? void 0 : x.startMin, q.dataMin),
                k ? q.min : c.toValue(c.toPixels(q.min) - c.minPixelPadding)
              )
              k = Math.max(
                a.pick(null === x || void 0 === x ? void 0 : x.startMax, q.dataMax),
                  ...
                  if (e) e[f ? 'animate' : 'attr']({ x: u.x, y: u.y })
                    ...
                    g &&
                      ((d.stateMarkerGraphic = e =
                        b.renderer.symbol(g, u.x, u.y, u.width, u.height).add(d.markerGroup)),
                      (e.currentSymbol = g))
      ...
      y !== (p && p.ruleIds) &&
        ...
        y
          ? ((p = this.currentOptions(f)),
            ...
            (this.currentResponsive = { ruleIds: y, mergedOptions: f, undoOptions: p }),
            this.update(f, a, !0))
