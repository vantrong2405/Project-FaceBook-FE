            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Thêm Mới Món Ăn</h1><button type="button"
        ...
        <div class="row">
            <div class="card" style="border-bottom: 5px solid  #AB826B;">
                <div class="card-header ">
                    <h4 class=" mb-0 text-center align-middle py-2"><b>Danh Sách
                            Tài Khoản Người Dùng</b></h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th class="bg-red-400 text-[blue] text-center align-middle text-nowrap"> # </th>
                                    <th class="bg-red-400 text-[blue] text-center align-middle text-nowrap">Tên tài
                                        khoản </th>
                                    <th class="bg-red-400 text-[blue] text-center align-middle text-nowrap">Địa chỉ</th>
                                    <th class="bg-red-400 text-[blue] text-center align-middle text-nowrap"> Tình Trạng
                                    </th>
                                    <th class="bg-red-400 text-[blue] text-center align-middle text-nowrap"> Action
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center align-middle text-nowrap"><button class="btn btn-danger"
                                            style="width: 100px;">Tạm Dừng</button></td>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-nowrap">55.000đ</td>
                                    <td class="text-center align-middle text-nowrap"><button class="btn btn-success"
                                            style="width: 100px;">Hiển Thị</button></td>
