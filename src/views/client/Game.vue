  ...
  <div class="flex">
    <div class="w-80 hidden xl:block">
      <div class="w-80">
        <div class="fixed">
          <div
            class="h-screen px-2 pb-12 pt-4 flex-col justify-between hidden xl:flex overflow-scroll"
          >
              ...
              <ul>
                ...
                <li>
                  <div class="flex items-center justify-between">
                    ...
                    <p
                      class="text-sm text-[#0866FE] py-[5px] px-[8px] hover:bg-[#F2F2F2] cursor-pointer"
                    >
                      Xem tất cả
                    </p>
                  </div>
                  <p class="text-xs text-[#898A8D] max-w-[300px] break-words">
                    Hãy lưu game vào phần Game của bạn để tạo lối tắt tại đây
                  </p>
                </li>
                <li
                  class="flex items-center gap-2 px-3 py-2 w-full cursor-pointer rounded-lg hover:bg-myGray-900 mt-4"
                >
                  <div class="bg-[#D8DADF] rounded-full p-1">
    ...
    <div class="overflow-hidden bg-[#F0F2F5] px-8">
      ...
      <div id="animation-carousel">
        <div class="py-[16px]">
          <div class="flex">
            <div
              class="dachoiganday mr-[8px] w-[12%] h-auto relative hover:brightness-90 cursor-pointer shadow-md"
            >
              <img
              ...
              />
              <p
                class="absolute text-[17px] bottom-[12px] left-[12px] text-white h-[40px] font-[600] leading-[20px]"
              >
                Words With <br />
                Friends
              </p>
              ...
              >
                <div class="w-full h-full flex flex-col rounded-lg overflow-hidden">
                  ...
                  <div class="w-full h-[38%] relative">
                    ...
                    />
                    <div
                      class="w-full h-full backdrop-blur-xl bg-black bg-opacity-10 absolute top-0"
                    >
                      <div class="mt-[6px] ml-[8px]">
                        <p class="text-white text-[17px] font-medium">Solitarie Classic</p>
                        <p
                          class="text-white text-[13px] font-medium inline-block bg-[#203820] py-[4px] px-[6px] mt-[5px] rounded-2xl"
                        >
      ...
      <div class="sss w-full mb-2">
        ...
        >
          <swiper-slide v-for="index in 20" :key="index">
            <div
              class="dachoiganday container w-full h-[200px] relative hover:brightness-90 cursor-pointer p-0"
            >
              <div class="w-full h-full flex flex-col rounded-lg overflow-hidden">
                <div class="w-full h-[62%]">
                  <img
                ...
                <div class="w-full h-[38%] relative">
                  <img
                    ...
                    alt=""
                  />
                  <div class="w-full h-full backdrop-blur-xl bg-black bg-opacity-10 absolute top-0">
                    <div class="mt-[6px] ml-[8px]">
                      <p class="text-white text-[17px] font-medium">Solitarie Classic</p>
                      <p
                        class="text-white text-[13px] font-medium inline-block bg-[#203820] py-[4px] px-[6px] mt-[5px] rounded-2xl"
