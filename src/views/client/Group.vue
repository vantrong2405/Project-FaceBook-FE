  ...
  <div class="flex">
    <div class="flex">
      <div class="w-80 hidden xl:block">
        <div class="w-80">
          <div class="fixed">
            <div
              class="h-screen ml-[5px] px-2 py-4 flex-col justify-between hidden xl:flex overflow-scroll"
            >
              <div id="left-bar-top" class="w-full">
                ...
                <div class="flex flex-row items-center justify-between my-[12px]">
                  ...
                  <p
                    class="rounded-md text-[15px] text-[#0064D1] py-[5px] px-[8px] cursor-pointer hover:bg-[#F2F2F2]"
                  >
                    Xem tất cả
                  </p>
                </div>
    ...
    <div class="mx-auto">
      ...
      <div class="shadow-md my-4 rounded-lg border bg-white" v-for="index in 10" :key="index">
        <div class="flex mb-3 justify-between m-[10px]">
          <div class="flex">
            <img
              ...
              class="w-[40px] h-[40px] rounded-lg mr-3"
              alt=""
            />
            <div>
              <div>
        ...
        <img
          src="data:image/jpeg;base64,"
          class="w-full h-[500px] object-cover mb-1 shadow-md"
          alt=""
        />
        <div class="flex items-center text-gray-500 mx-3 py-2 justify-between">
          <div class="flex">
            <div
              class="flex items-center px-[10px] py-[6px] cursor-pointer hover:bg-[#F2F2F2] rounded-lg"
            >
          ...
          <div class="flex text-xs">
            <i
              class="fas fa-thumbs-up ml-auto rounded-full bg-[#049CFD] text-white w-5 h-5 items-center text-xs px-1 pt-0.5"
            ></i>
            <i
              class="fa-solid fa-heart mr-0.5 rounded-full bg-[#FC464E] text-white w-5 h-5 items-center text-xs px-1 pt-0.5"
            ></i>
