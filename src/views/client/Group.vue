<template>
  <div class="flex">
    ...
    <div class="mx-auto">
      <p class="font-medium mt-[20px] mb-[-10px]">Hoạt động gần đây</p>
      <div class="shadow-md my-5 rounded-lg border bg-white" v-for="index in 10" :key="index">
        <div class="flex mb-3 justify-between m-4">
          <div class="flex">
            <img
              ...
              class="w-10 h-10 rounded-lg mr-3 cursor-pointer" alt="" />
            <div>
              <div>
        ...
        <img
          src="data:image/jpeg;base64,"
          class="w-full h-[500px] object-cover mb-4 shadow-md" alt="" />
        <div class="flex items-center text-gray-500 mx-3 py-2 justify-between">
          <div class="flex items-center">
            ...
            <p>Comment</p>
            <i class="fas fa-share ml-4 mr-2"></i>
            <p>Share</p>
          </div>
          <div class="flex text-xs">
            ...
            <span class="mr-2">Thanh Thư và 22K người khác</span>
            <p class="mr-2">80 bình luận</p>
