...
var FullCalendar = (function (e) {
  ...
  function R(e, t, n, r, o, i, a, s, l) {
    ...
    if (
      ...
      (t.__k = T(t.__k, function (n) {
        if (null != n) {
          if (((n.__ = t), (n.__b = t.__b + 1), null === (d = E[u]) || (d && n.key == d.key && n.type === d.type)))
            E[u] = void 0
          else
            for (c = 0; c < S; c++) {
          ...
          if (
            ...
            (c = n.ref) && d.ref != c && (y || (y = []), d.ref && y.push(d.ref, null, n), y.push(c, n.__c || h, n)),
            null != h)
          ) {
            var f
  ...
  function k(e, t, n) {
    "-" === t[0]
      ? e.setProperty(t, n)
      : (e[t] = "number" == typeof n && !1 === h.test(t) ? n + "px" : null == n ? "" : n)
  }
    ...
    if ((o ? "className" === t && (t = "class") : "class" === t && (t = "className"), "style" === t))
      ...
      "o" === t[0] && "n" === t[1]
        ? ((a = t !== (t = t.replace(/Capture$/, ""))),
          ...
          n ? (r || e.addEventListener(t, x, a), ((e.l || (e.l = {}))[t] = n)) : e.removeEventListener(t, x, a))
        ...
        if (
          ...
          n.__c
            ...
            : ("prototype" in C && C.prototype.render
                ? (t.__c = d = new C(y, b))
                : ((t.__c = d = new S(y, b)), (d.constructor = C), (d.render = O)),
              D && D.sub(d),
              (d.props = y),
              d.state || (d.state = {}),
              (d.context = b),
          ...
          null != C.getDerivedStateFromProps &&
            (d.__s == d.state && (d.__s = v({}, d.__s)), v(d.__s, C.getDerivedStateFromProps(y, d.__s))),
          (f = d.props),
          (h = d.state),
          p)
        )
          ...
          if (
            ...
            (!d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(y, d.__s, b)) ||
              (t.__v === n.__v && !d.__))
          ) {
            for (
              d.props = y,
  ...
  function P(e, t, n, r, o, i, a, s) {
    ...
    if (null === t.type) v !== g && e.data != g && (e.data = g)
      ...
      ;(function (e, t, n, r, o) {
        ...
        d ? (t.__k = []) : ((t.__k = t.props.children), R(e, t, n, r, "foreignObject" !== t.type && o, i, a, p, s)),
        s ||
          ("value" in g && void 0 !== (l = g.value) && l !== e.value && M(e, "value", l, v.value, !1),
  ...
  function qt(e, t, n, r, o) {
    ...
    if (u)
      return (
        ((c = Xt(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
          typeId: u.typeId,
          typeData: u.typeData,
          duration: u.duration
        }),
  ...
  function xn(e, t, n) {
    n.emitter.trigger(
      "select",
      r(r({}, _n(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
    )
  }
  function _n(e, t) {
  ...
  function In(e, t, n) {
    var r = n.dateEnv,
      ...
      i = t
    return (
      e ? ((i = be(i)), (i = r.add(i, o.defaultAllDayEventDuration))) : (i = r.add(i, o.defaultTimedEventDuration)), i
    )
  }
  function Pn(e, t, n, r) {
    var o = pn(e.defs, t),
  ...
  function Hn(e, t, n, o, i) {
    ...
    return (
      ...
      l && (u.range = { start: u.range.start, end: In(t.allDay, u.range.start, i) }),
      t.allDay && (u.range = { start: be(u.range.start), end: be(u.range.end) }),
          ...
          if (e instanceof zn) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({ type: "ADD_EVENTS", eventStore: Pt({ def: n, instance: r }) }),
      ...
      return (
        ...
        (e.prototype.createMarkerMeta = function (e) {
          ...
          return (
            ...
            null !== t && xe(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } : null
          )
        }),
        ...
        (e.prototype.toDate = function (e, t) {
          return "local" === this.timeZone
            ...
            : "UTC" === this.timeZone
              ? new Date(e.valueOf())
              : this.namedTimeZoneImpl
                ? new Date(e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(ke(e)) * 60)
  ...
  function br(e, t) {
    ...
    return (
      Er() && "rtl" === n.direction ? (u.scrollbarLeft = l) : (u.scrollbarRight = l),
      t &&
  ...
  var Co = (function () {
    ...
    return (
          ...
          r.duration
            ...
            : (n = this.props.dayCount)
              ...
              : (a = this.buildCustomVisibleRange(e))
                ...
                : ((i = et((o = this.getFallbackDuration())).unit), (a = this.buildRangeFromDuration(e, t, o, i))),
      ...
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Je(n) <= 1 && this.isHiddenDay(o) && (o = be((o = this.skipHiddenDays(o, t)))),
          d(),
  ...
  var Pi = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, o = [], i = [], a = -1; n < r; )
          t.isHiddenDay(n) ? o.push(a + 0.5) : (a++, o.push(a), i.push(n)), (n = ve(n, 1))
  ...
  function Fi(e, t, n) {
    ...
    return "function" == typeof t.content
      ...
      : Hr(
          ...
          n.tableColGroupNode,
          Hr("tbody", {}, "function" == typeof t.rowContent ? t.rowContent(n) : t.rowContent)
        )
  }
  function Bi(e, t) {
    return ot(e, t, Le)
          ...
          return Hr(
            ...
            function (t, o, i, a, s) {
              return Hr(
                ...
                Hr("div", { className: "fc-event-main", ref: i, style: { color: s.textColor } }, a),
                s.isStartResizable && Hr("div", { className: "fc-event-resizer fc-event-resizer-start" }),
                s.isEndResizable && Hr("div", { className: "fc-event-resizer fc-event-resizer-end" })
              )
            }
          )
        }),
  ...
  function ta(e) {
    return Hr(
      ...
      Hr(
        ...
        Hr("div", { className: "fc-event-title fc-sticky" }, e.event.title || Hr(Ur, null, " "))
      )
    )
  }
  var na = function (e) {
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            var e = o.currentData
            Or(
              Hr(bi, { options: e.calendarOptions, theme: e.theme, emitter: e.emitter }, function (t, n, i, a) {
                return (
                  o.setClassNames(t),
                  o.setHeight(n),
                  Hr(co.Provider, { value: o.customContentRenderId }, Hr(Ei, r({ isHeightAuto: i, forPrint: a }, e)))
                )
              }),
              o.el
            )
      ...
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
            ...
            --ha || window.removeEventListener("touchmove", ma, { passive: !1 })
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0 ? (this.everMovedUp = !0) : o > 0 && (this.everMovedDown = !0),
              ...
              this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(ba()))
          }
        }),
            ...
            if (r.isInteracting) {
              ...
              r.isDragging &&
                ("scroll" !== e.origEvent.type &&
                  (r.mirror.handleMove(e.pageX, e.pageY), r.autoScroller.handleMove(e.pageX, e.pageY)),
              ...
              i === a || (p.editable && p.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  d.isInteractionValid(c) ||
                    ((u = !0), (s = null), (l = null), (c.mutatedEvents = { defs: {}, instances: {} })))
                : (a = null)
            }
            o.displayDrag(a, c),
              u ? Q() : ee(),
      ...
      ;(n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, o) {
          ...
          e &&
            ...
            d ? Q() : ee(),
            t || (u && ka(s, e) && (u = null), (n.validMutation = u), (n.mutatedRelevantEvents = c))
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
          ...
          (this.handleHitUpdate = function (e, t, o) {
            ...
            e &&
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ...
                (l = !Jr(u, a)) && ((u.mutatedEvents = { defs: {}, instances: {} }), (s = null)))),
              n.displayDrag(a, u),
            ...
            function (t, o, c, d) {
              return Hr(
                ...
                Hr(
                  ...
                  i.showWeekNumber &&
                    Hr(ca, { date: a, defaultFormat: ja }, function (e, t, n, o) {
  ...
  function $a(e) {
    return Hr(
      ...
      e.timeText && Hr("div", { className: "fc-event-time" }, e.timeText),
      Hr("div", { className: "fc-event-title" }, e.event.title || Hr(Ur, null, " "))
    )
  }
  var Qa = (function (e) {
    function t() {
            ...
            b
              ...
              h.push(
                Hr(
                  ...
                  Ka(m)
                    ? Hr(Ja, r({ seg: m, isDragging: s, isSelected: y === d, defaultDisplayEventEnd: f }, Sn(m, a)))
                    : Hr(
                        Qa,
                        r(
                          {
        ...
        if (a)
          for (var l = 0, u = e; l < u.length; l++) {
            ...
            s.push(
              Hr(
                "div",
                { key: bn(c.eventRange), className: "fc-daygrid-bg-harness", style: d },
          ...
          (t.handleMoreLinkClick = function (e) {
            ...
            "function" == typeof i &&
              ...
              i && "popover" !== i
                ...
                : t.setState({
                    morePopoverState: r(r({}, e), { currentFgEventSegs: t.props.fgEventSegs })
                  })
          }),
            ...
            return (
              ...
              (t.prototype.buildRenderRange = function (t, n, r) {
                var o,
                  ...
                  l = a.end
                ;(/^(year|month)$/.test(n) &&
                  ((s = i.startOfWeek(s)), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = he(o, 1))),
        ...
        (t.prototype.render = function () {
          ...
          return Hr(
            ...
            Hr(
              ...
              e.tableColGroupNode,
              Hr(ys, { slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas })
            )
          )
        }),
        (t.prototype.componentDidMount = function () {
  ...
  function bs(e, t, n, r, o) {
    for (
      ...
      var c = o.add(i, a),
        d = null !== Qe(s, l)
      u.push({ date: c, time: a, key: c.toISOString(), isoTimeStr: nt(c), isLabeled: d }),
        (a = Xe(a, r)),
        (s = Xe(s, r))
    }
    return u
        ...
        return (
          ...
          (t.renderHeadAxis = function (e) {
            ...
            return n.weekNumbers
              ? Hr(ca, { date: o.start, defaultFormat: Cs }, function (t, n, o, i) {
                  return Hr(
                    "th",
                    {
                      ref: t,
              ...
              : Hr(
                  ...
                  Hr("div", { className: "fc-timegrid-axis-frame", style: { height: e } })
                )
          }),
                      ...
                      Hr(
                        ...
                        Hr(Mi, { unit: h ? "minute" : "day" }, function (e) {
                          ...
                          return "number" == typeof t
                            ? Hr(na, { isAxis: !0, date: e }, function (e, n, r, o) {
                                return Hr(
                                  "div",
                                  {
                                    ref: e,
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Hr(ea, r({}, this.props, { defaultTimeFormat: Os, extraClassNames: e }))
          )
        }),
        t
      )
            ...
            function (a, s, l) {
              return Hr(
                ...
                Hr(
                  ...
                  Hr("div", { className: "fc-timegrid-col-events" }, e.renderFgSegs(t.fgEventSegs, i)),
                  Hr(
                    "div",
                    ...
                    Hr(
                      ...
                      Hr(
                        ...
                        Hr(
                          ...
                          { className: "fc-timegrid-now-indicator-container" },
                          "number" == typeof n &&
                            Hr(na, { isAxis: !0, date: t.nowDate }, function (e, t, r, o) {
                              return Hr(
                                "div",
                                {
                                  ref: e,
        ...
        (t.prototype.render = function () {
          ...
          return Hr(
            ...
            function (e, n, r, o) {
              return Hr(
                "tr",
                { ref: e, className: h.concat(n).join(" "), "data-date": tt(t) },
                Hr(
                  "th",
                  { colSpan: 3 },
                  Hr("div", { className: "fc-list-day-cushion " + i.getClass("tableCellShaded"), ref: r }, o)
                )
              )
            }
          )
  ...
  function Xs(e) {
    ...
    return Hr(
      ...
      e.sideText && Hr("a", r({ className: "fc-list-day-side-text" }, t), e.sideText)
    )
  }
    ...
    return (
      ...
      (t.prototype._eventStoreToSegs = function (e, t, n) {
        return this.eventRangesToSegs(
          ln(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg,
          n
        )
      }),
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = ve(e.start, -1).toISOString()), (s = ve(e.end, 1).toISOString()))
                ;(i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
