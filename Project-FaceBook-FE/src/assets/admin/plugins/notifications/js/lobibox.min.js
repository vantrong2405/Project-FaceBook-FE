...
!(function () {
  ...
  var LobiboxBase = {
    ...
    _onButtonClick: function (buttonOptions, type) {
      var me = this
      ;(("ok" === type && "prompt" === me.$type && me.isValid()) || "prompt" !== me.$type || "ok" !== type) &&
        buttonOptions &&
    ...
    _createMarkup: function () {
      ...
      if (
        (lobibox.append(header), lobibox.append(body), me.$options.buttons && !$.isEmptyObject(me.$options.buttons))
      ) {
        var footer = $('<div class="lobibox-footer"></div>')
        footer.append(me._generateButtons()),
          lobibox.append(footer),
          Lobibox.base.OPTIONS.buttonsAlign.indexOf(me.$options.buttonsAlign) > -1 &&
      ...
      function callback() {
        me.$el.addClass("lobibox-hidden"),
          0 === $(".lobibox[data-is-modal=true]:not(.lobibox-hidden)").length &&
            ($(".lobibox-backdrop").remove(), $("body").removeClass(Lobibox.base.OPTIONS.bodyClass))
      }
      var me = this
      return (
  ...
  ;(Lobibox.base = {}),
    ...
    (LobiboxProgress.prototype = $.extend({}, LobiboxBase, {
      ...
      _createProgressbar: function () {
        var me = this,
          outer = $('<div class="lobibox-progress-bar-wrapper lobibox-progress-outer"></div>').append(
  ...
  var LobiboxNotify = function (type, options) {
    ...
    var me = this,
      _processInput = function (options) {
        return (
          ...
          "mini" !== options.size && options.title === !0
            ...
            : "mini" === options.size && options.title === !0 && (options.title = !1),
      ...
      _createNotifyWrapper = function () {
        var $wrapper,
          selector =
            ("large" === me.$options.size ? ".lobibox-notify-wrapper-large" : ".lobibox-notify-wrapper") +
            "." +
