        ...
        _createClass(s, [
            ...
            value: function () {
              ...
              this.main.data("click-init", !0),
                v(this.steps).on("click", function (t) {
                  ...
                  return (
                    e === s.current_index ||
                    !(!1 !== s.options.anchorSettings.enableAnchorOnDoneStep || !s._isDone(e)) ||
                    void ((!1 === s.options.anchorSettings.enableAllAnchors && !s._isDone(e)) || s._showStep(e))
                  )
                }),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (null !== this.current_index && !1 === this._triggerEvent("leaveStep", [t, this.current_index, i]))
                return !1
            ...
            value: function (t) {
              this._resetCSSClass(this.current_index, "active"),
                !1 !== this.options.anchorSettings.markDoneStep &&
                  ...
                  !1 !== this.options.anchorSettings.removeDoneStepOnNavigateBack &&
              ...
              if (!this.options.cycleSteps)
                switch (
                  ...
                  case "last":
                    ...
                    break
                  default:
                    !1 === this._getNextShowable(t) && this.main.find(".sw-btn-next").addClass("disabled"),
                      !1 === this._getPreviousShowable(t) && this.main.find(".sw-btn-prev").addClass("disabled")
                }
            }
          },
          {
          ...
          },
          {
            key: "_keyNav",
            value: function (t) {
              if (-1 < v.inArray(t.which, this.options.keyboardSettings.keyLeft))
  ...
  v.fn.smartWizard = function (t) {
    ...
    if ("string" == typeof t && "_" !== t[0] && "init" !== t) {
      ...
      return (
        ...
        e instanceof s && "function" == typeof e[t] ? e[t].apply(e, Array.prototype.slice.call(arguments, 1)) : this
      )
    }
  }
