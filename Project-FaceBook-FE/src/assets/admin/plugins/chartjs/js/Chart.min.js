                    ...
                    for (t.beginPath(), r = 0, s = p + !!o; r < s; ++r)
                      (h = i((u = e[(l = r % p)]._view), l, n)),
                        ...
                        f && g
                          ...
                          : x &&
                            y &&
                            (m ? (f && v.push(u), g && b.push(h)) : (c(t, v, b, x, y), (x = y = 0), (v = []), (b = [])))
  ...
  "undefined" === typeof Chart
    ...
    : ((c.prototype.beforeDatasetsUpdate = function (a) {
      ...
      (c.prototype.drawDataset = function (a) {
        for (
          var b = this.ctx, p = this.chartInstance, l = a._meta[Object.keys(a._meta)[0]], h = 0, f = 0;
          f < l.data.length;
          f++
        ) {
          var g = l.data[f],
            ...
            switch (this.render) {
              ...
              default:
                ...
                this.showActualPercentages ||
                  ((h += q), 100 < h && ((q -= h - 100), (q = parseFloat(q.toFixed(this.precision)))))
                e = q + "%"
            }
            ...
            if (this.arc)
              ...
              ;(this.overlap ||
                ("outside" === this.position
                  ...
                  : g.inRange(d, t) && g.inRange(d, u) && g.inRange(k, t) && g.inRange(k, u))) &&
                this.fillText(e, n, m)
            }
            b.restore()
          }
      ...
      (c.prototype.measureText = function (a) {
        return "object" === typeof a ? { width: a.width, height: a.height } : this.ctx.measureText(a)
      }),
      (c.prototype.fillText = function (a, b, p) {
        var c = this.ctx
        "object" === typeof a
          ? c.drawImage(a, b.x - a.width / 2, b.y - a.height / 2, a.width, a.height)
          : ((c.fillStyle = p),
            (c.textBaseline = "top"),
            (c.textAlign = "center"),
